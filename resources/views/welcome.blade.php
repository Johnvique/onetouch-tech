...
<html lang="en">
  <head>
    <title>ONE TOUCH TECHNOLOGIES| Home</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h4 class="mb-0 site-logo"><a href="{{url('/')}}" class="text-black h4 mb-0">One Touch Technologies<span class="text-primary"></span> </a></h4>
          </div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            <p>
         <p style="color: #FFFFFF;">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | ONE TOUCH TECHNOLOGIES.</p>
      </p>
            </div>
          </div>
